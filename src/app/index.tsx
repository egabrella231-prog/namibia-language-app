...
swapText: { color: '#fff', fontWeight: '800' }, This is my full code for index.tsx. Don't change it again. Just make sure that this codes this youi. Is responsive fully to both tables in my Data Base. 
